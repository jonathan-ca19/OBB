...
class Docente(persona):
    ...
    def __init__(self, nombre, apellido, titulo, edad, experienciaProfesional, experienciaDocente):
        ...
        def BienvenidaDocente(self):
            print("Estimado Docente:"+ self.nombre, self.apellido+ ". Le damos la bienvenida al IST YAVIRAC "+"agradecemos contar con sus"+ str(self.experienciaDocente + self.experienciaProfesional)+ " años de experiencia")
            
            
docente1 = Docente("Dayana", "Tafur", "Desarrolladora de Software", 24, 2, 1)
